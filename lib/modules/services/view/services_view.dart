...
class ServicesView extends StatelessWidget {
        ...
        return Center(
          child: Column(
            ...
            children: [
              ...
              Text('Failed to load requests', style: AppTheme.heading3),
              const SizedBox(height: 8),
              Text(
                sc.errorMessage.value,
                style: AppTheme.caption,
                textAlign: TextAlign.center,
              ),
              const SizedBox(height: 20),
              ElevatedButton.icon(
                onPressed: sc.refresh,
      ...
      return SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Click on a service to view property requests',
              style: AppTheme.caption,
            ),
            ...
            Wrap(
              ...
              children:
                  AppConstants.serviceTypes.map((type) {
                    final color =
                        AppConstants.serviceColors[type] ?? AppTheme.accentCyan;
                    ...
                    return SizedBox(
                      ...
                      child: GlassCard(
                        color: Colors.white,
                        borderColor:
                            isSelected ? AppTheme.accentBlue : AppTheme.border,
                        glowColor:
            ...
            Obx(() {
              if (sc.searchQuery.value.isNotEmpty) {
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        const Spacer(),
                        StatusBadge(
                          label: '${sc.filteredRequests.length} results',
                    ...
                    if (sc.filteredRequests.isEmpty)
                      ...
                      _buildRequestList(context, sc.filteredRequests),
                  ],
                );
              } else if (sc.selectedServiceType.value.isNotEmpty) {
                return Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Row(
                      children: [
                        Text(
                          '${sc.selectedServiceType.value} Requests',
                          style: AppTheme.heading2,
                        ),
                        const Spacer(),
                        StatusBadge(
                ...
                return Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Recent Service Requests', style: AppTheme.heading2),
                    const SizedBox(height: 16),
                    if (sc.recentRequests.isEmpty)
                      const Center(
                        child: Padding(
                          padding: EdgeInsets.symmetric(vertical: 40),
                          child: Text(
                      ...
                      _buildRequestList(context, sc.recentRequests),
                  ],
                );
              }
            }),
  ...
  Widget _buildRequestList(BuildContext context, List<dynamic> requests) {
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            SizedBox(
                              width: 170,
                              child:
                                  req.isCompleted && req.completedDate != null
                                      ? Row(
                                        children: [
                                          const Icon(
                                          ...
                                          Expanded(
                                            child: Text(
                                              'Completed: ${req.completedDate!.day}/${req.completedDate!.month}/${req.completedDate!.year}',
                                              style: AppTheme.caption.copyWith(
                                                fontSize: 10.5,
                                                color: Colors.black,
                                              ),
